...
class JsonDecoder implements JsonDecoderInterface
{
    ...
    {
        $defer = function (mixed $result) use ($default): array {
            ...
            throw new JsonException("Failed to convert json string into PHP array.");
        };
        ...
        return $defer($this->unmarshalMixed($jsonString));
    }
